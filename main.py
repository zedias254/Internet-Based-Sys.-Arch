    ...
    temp1 = """
		...
		<body background="http://www.seim.cl/wp-content/uploads/6793522-free-office-wallpaper.jpg">
            <div class="wrapper">
                ...
                <p> </p>
                <p class="main3">
                <input type="button" class="button" value="Administrator" onclick="location.href='https://asint-156018.appspot.com/init/admin/';" />
                <input type="button" class="button" value="Student" onclick="location.href='https://asint-156018.appspot.com/init/student/register/';" />
                </p>
            </div>
        </body>
    """
    ...
    temp1 = """
       ...
       <body background="http://www.seim.cl/wp-content/uploads/6793522-free-office-wallpaper.jpg">
        <div id="add" class="wrapper">
            ...
            %for campus in json:
                <p>
                <a href="https://asint-156018.appspot.com/init/admin/search/{{campus["id"]}}"> {{campus["name"]}} </a>
                </p>
            % end
            <input type="button" class="button" value="Back" onclick="location.href='https://asint-156018.appspot.com/init/admin/';" />
        </div>
        ...
        <div id ="back" class="wrapper">
            ...
            <button class="button" onclick="location.href='https://asint-156018.appspot.com/init/admin/';">Back</button>
        </div>
        </body>
        ...
        <script>
            ...
            function l_rooms() {
                    ...
                    if (xmlHttp.readyState == 4 && xmlHttp.status == 200){
                        ...
                        if(list_of_rooms["containedRooms"].length == 0){
                            ...
                            for(var i = 0; i < list_of_rooms["containedRooms"].length; i++) {
                                ...
                                link.setAttribute('href','https://asint-156018.appspot.com/init/admin/occupation/'+obj.id);
                                link.text=obj.name;
                ...
                xmlHttp.open("GET", "https://asint-156018.appspot.com/init/listrooms/0", true);
                xmlHttp.send(null);
            }
        </script>
    """
...
def student():
    temp1 = """
		...
		<div class="wrapper">
            ...
            <br>
			<button class="button" onclick="location.href='https://asint-156018.appspot.com/init/';">Back</button>
		    <br>
		</div>
		</body>
    """
    ...
    if query:
        ...
        temp1 = """
        	...
        	<div class="wrapper">
                ...
                <br>
        		<button class="button" onclick="location.href='https://asint-156018.appspot.com/init/student/{{new_id}}';"> See available rooms</button>
        	</div>
        	</body>
        """
        ...
        ret = """
            ...
            <div id="metric_results" class="wrapper">
                ...
                <script>
                    ...
                    xmlHttp.onreadystatechange = function() {
                        if (xmlHttp.readyState == 4 && xmlHttp.status == 200){
                            ...
                            if(list_of_rooms["ErrorCode"]){
                                ...
                                for(var i = 0; i < list_of_rooms["containedRooms"].length; i++) {
                                    ...
                                    var tdname = document.createElement('TD');
                                     var link = document.createElement("A");
                                    link.setAttribute('href','https://asint-156018.appspot.com/init/student/{{student_id}}/'+obj.id);
                                    link.text=obj.name;
                                    tdname.appendChild(link);
                                    tr.appendChild(tdname);
                                    tableBody.appendChild(tr);
                        ...
                        xmlHttp.open("GET", "https://asint-156018.appspot.com/init/listrooms/{{student_id}}", true);
                            xmlHttp.send(null);
                </script>
                <br>
                <p id="error2"></p>
            ...
            <script>
                ...
                function Search_friend() {
                    ...
                    xmlHttp.open("GET", "https://asint-156018.appspot.com/init/student/"+String(friend_username.elements[0].value)+"/room", true);
                    xmlHttp.send(null);
                }
            </script>
            """
    ...
    ret = """
        ...
        <div id="metric_results" class="wrapper">
            ...
            <script>
                ...
                xmlHttp.open("GET", "https://asint-156018.appspot.com/init/liststudents/{{room_id}}", true);
                xmlHttp.send(null);
            </script>
...
def search(room_id):
    ...
    if not response_json["containedSpaces"]:
		...
		<div class="wrapper">
            ...
            <input type="button" class="button" value="Back" onclick="window.history.back()"/>
            <input type="button" class="button" onclick="location.href='https://asint-156018.appspot.com/init/admin/';" value="Go to Admin Homepage"/>
            <p id="check"></p>
        </div>
        </body>
        <script>
    ...
    """
        ...
        %for room in json["containedSpaces"]:
            <p>
            <a href="https://asint-156018.appspot.com/init/admin/search/{{room["id"]}}">
            {{room["name"]}}
            </a>
            </p>
        % end
...
def room_occupation(room_id):
    ...
    try:
        ...
        ret = """
                    <p>Error! ID not found. </p>
        """
        return template(ret, room_id=room_id)

    students = StudentS.query(StudentS.room_id == r_id).fetch()
    q_current_room = RoomR.query(RoomR.id == str(room_id)).fetch(1)[0]
    room_name = q_current_room.name
